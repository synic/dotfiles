...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(company-tooltip-annotation ((t (:inherit company-tooltip :foreground "#8197bf"))))
       `(company-tooltip-common ((t (:inherit company-tooltip :background "#151515" :foreground "white" :underline nil :weight bold))))
       `(company-tooltip-common-selection ((t (:inherit company-tooltip-selection :foreground "#8197bf" :underline nil :weight bold))))
       ...
       `(neo-dir-link-face ((t (:foreground "#8197bf"))))
       ...
       `(helm-selection ((t (:background "#333344"))))
       ...
       `(powerline-active1 ((t (:inherit mode-line :background "#333344"))))
       `(powerline-active2 ((t (:inherit mode-line :background "#333344"))))
       ...
       `(magit-diff-context-highlight ((t (:background "black" :foreground ,jbeans-fg))))
       `(magit-diff-file-heading ((t (:background "black" :weight bold))))
       ...
       `(magit-diff-hunk-heading ((t (:background "#333344" :foreground "white"))))
       `(magit-diff-hunk-heading-highlight ((t (:background "#444455" :foreground "white"))))
       ...
       `(magit-section-heading ((t (:background "black" :foreground "#fad07a"))))
       `(magit-section-highlight ((t (:background "black"))))
       `(magit-section-secondary-heading ((t (:background "black" :weight bold))))
       ...
       `(sp-pair-overlay-face ((t (:background "#112433"))))
